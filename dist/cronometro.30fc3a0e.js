...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/cronometro.js":[function(require,module,exports) {
var botaoStart = document.querySelector('.btn.btn-success');
var botaoPause = document.querySelector('.btn.btn-warning');
var botaoStop = document.querySelector('.btn.btn-danger');
botaoStart.addEventListener('click', function () {
  return computa('inicia');
});
botaoPause.addEventListener('click', function () {
  return computa('pausa');
});
botaoStop.addEventListener('click', function () {
  return computa('reinicia');
});
var output = document.querySelector('output');
var contagem = 0;
var estado = 'parado';
var timer; // MÁQUINA DE ESTADOS:
// Estados:
// - Parado
...
function computa(acao) {
  ...
  output.innerHTML = "".concat(paraDecimalFixo(contagem), " s");
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/cronometro.js"], null)
//# sourceMappingURL=/cronometro.30fc3a0e.js.map